...
class BatchGenerator(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        yolo_1 = np.zeros((r_bound - l_bound, 1*base_grid_h,  1*base_grid_w, len(self.anchors)//3, 4+1+len(self.labels))) # desired network output 1  len(anchors) // #layers
        ...
        #yolos = [yolo_2, yolo_1]       ## why should we use the reverse order of yolo layer here?
        ...
        for train_instance in self.instances[l_bound:r_bound]:
            ...
            for obj in all_objs:
                ...
                yolo[instance_count, grid_y, grid_x, max_index%3] = 0 # max_index%3 == ID anchor
                yolo[instance_count, grid_y, grid_x, max_index%3, 0:4] = box
                yolo[instance_count, grid_y, grid_x, max_index%3, 4] = 1.0
    ...
    def _get_net_size(self, idx):
        ...
        # print(">> resizing: ", self.net_h, self.net_w, "\tTotal Images:", self.counter * self.batch_size)
