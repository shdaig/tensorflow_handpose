...
def build_model(image_size,
    ...
    # print(anchors4.shape)
    # print(anchors5.shape)
    # print(anchors6.shape)
    # print(anchors7.shape)
    ...
    # print(anchors4_reshaped.shape)
    # print(anchors5_reshaped.shape)
    # print(anchors6_reshaped.shape)
    # print(anchors7_reshaped.shape)
