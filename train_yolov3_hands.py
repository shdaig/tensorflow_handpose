...
checkpoint = CustomModelCheckpoint(
    ...
    filepath        = 'checkpoints/yolov3/yolov3_hands_epoch-{epoch:02d}_loss-{loss:.4f}_valloss-{val_loss:.4f}.h5', 
    monitor         = 'val_loss', 
    verbose         = 1, 
    save_best_only  = True, 
    mode            = 'min', 
...
infer_model.save_weights("hand_weights_yolov3.h5")
print("--weights saved--")
infer_model.save("hand_model_yolov3")
print("--model saved--")
...
plt.savefig('history_yolov3.png')
plt.savefig('history_yolov3.pdf')
print("--plot saved--")
